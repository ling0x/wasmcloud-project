...
use bindings::exports::wasmcloud::calculation::calculator::{Handler, Numbers};
// The code generated by `wit-bindgen-wrpc` for your imports follow a pattern:
// crate::<world_name>::<namespace>::<package>::<interface>::*
use bindings::wasmcloud::calculation::process_data;
use bindings::wasmcloud::calculation::process_data::Data;
